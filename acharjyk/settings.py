"""
Django settings for acharjyk project.
...
SECRET_KEY = 'django-insecure-serh6f3lgs1$++lrw@+6^-1nhwef1^44md4sqk@vqbvhrkl#)@'
...
WSGI_APPLICATION = 'acharjyk.wsgi.application'
...
# You don't need to worry about this yet, but it's good practice to set it
